...
<tr><td  rowspan="80px"><img id = "logo" src="hospital.png" alt="New Horizons Hospital"/></td><td class = "hdg">NEW</td><td id="p_title" rowspan="60px" style = "padding-left:300px;font-size:60px;font-family:Comfortaa;">                                       PHARMACY</td></tr>
...
<button class="tablinks" onclick="phar(event, 'home')"><div class="navbar">HOME</div></buttton>
 <a href="pharmacy_view.php" style="text-decoration:none;"><button class="tablinks"><div class="navbar">VIEW</div></buttton></a>
 <button class="tablinks" onclick="phar(event, 'update')"><div class="navbar">UPDATE</div></buttton>
 <button class="tablinks" onclick="phar(event, 'sell')"><div class="navbar">SELL</div></buttton>
 <button class="tablinks" onclick="phar(event, 'search')"><div class="navbar">SEARCH</div></buttton>
